...
export const restaurant: Restaurant = {
  ...
  openingHours: "Dom: 09h às 11h30 | Ter a Sex: 09h30 às 17h30 | Sáb: 09h às 17h",
  weeklySchedule: [
...
export const categories: Category[] = [
  ...
  { id: "cat_festa", restaurantId: restaurant.id, name: "Velas e descartáveis", sortOrder: 6, active: true },
...
export const products: Product[] = [
  {
    ...
    description: "Bolo de pote brigadeiro, tortinha de limão e brigadeiro individual em preço especial.",
  ...
  },
  {
    ...
    description: "Morango, limão e Ferrero Rocher em uma seleção especial do dia.",
  ...
  },
  {
    ...
    description: "Mini tortinha de morango e mini tortinha de limão em combo promocional.",
  ...
  },
  {
    ...
    description: "Bolo de pote Prestígio com Coca-Cola mini 200 ml.",
  ...
  },
  {
    ...
    description: "Bolo no pote com recheio de Ninho e creme de avelã.",
  ...
  },
  {
    ...
    description: "Base crocante com creme de limão e finalização delicada.",
  ...
  },
  {
    ...
    description: "Tortinha com chocolate, creme de avelã e castanhas.",
  ...
  },
  {
    ...
    description: "Porção com 50 mini salgados tradicionais para compartilhar.",
  ...
  },
  {
    ...
    description: "Mini salgados crocantes em porção menor para qualquer ocasião.",
  ...
  },
  {
    ...
    name: "100 Docinhos",
    description: "Brigadeiro, beijinho, ninho e bicho de pé para festas.",
  ...
  },
  {
    ...
    description: "Vela numérica luxo rosa para comemorações.",
  ...
  },
  {
    ...
    description: "Pacote de garfinhos descartáveis com 50 unidades.",
  ...
  },
  {
    ...
    description: "Refrigerante de limão gelado em lata.",
